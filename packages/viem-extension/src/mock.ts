...
const PARTNERS: PartnerRecord[] = [
    { id: "elena", name: "Elena Moroz", avatarSeed: "Elena Moroz", status: "active" },
    { id: "marcus", name: "Marcus Hale", avatarSeed: "Marcus Hale", status: "active" },
    { id: "felix", name: "Felix Armand", avatarSeed: "Felix Armand", status: "active" },
    { id: "marta", name: "Marta Klein", avatarSeed: "Marta Klein", status: "active" },
    { id: "ava", name: "Ava Laurent", avatarSeed: "Ava Laurent", status: "active" },
    { id: "jon", name: "Jon Beck", avatarSeed: "Jon Beck", status: "active" },
    { id: "nina", name: "Nina Doyle", avatarSeed: "Nina Doyle", status: "active" },
    { id: "clara", name: "Clara Dunn", avatarSeed: "Clara Dunn", status: "active" },
    { id: "john", name: "John Mercer", avatarSeed: "John Mercer", status: "active" },
    { id: "paul", name: "Paul Novak", avatarSeed: "Paul Novak", status: "active" },
    { id: "maria", name: "Maria Dvorak", avatarSeed: "Maria Dvorak", status: "active" },
    { id: "anna", name: "Anna Kovac", avatarSeed: "Anna Kovac", status: "active" },
    { id: "sarah", name: "Sarah Lewis", avatarSeed: "Sarah Lewis", status: "active" },
    { id: "bob", name: "Bob Turner", avatarSeed: "Bob Turner", status: "active" },
    { id: "alice", name: "Alice Chen", avatarSeed: "Alice Chen", status: "active" },
    { id: "mila", name: "Mila Ross", avatarSeed: "Mila Ross", status: "active" },
];
...
const PROJECTS: ProjectRecord[] = [
    {
        id: "product-waiting-research-panel",
        circleId: "product",
        roleId: "product-circle",
        title: "User testing research panel",
        stage: "waiting",
        ownerId: "ava",
        subtitle: "Recruit and sequence design partners",
        accentToken: "bg-indigo-500",
        sourceMeetingId: "product-roadmap-review",
    },
    {
        id: "product-current-release-rhythm",
        circleId: "product",
        roleId: "product-circle",
        title: "Release quality review rhythm",
        stage: "current",
        ownerId: "felix",
        subtitle: "Cross-functional release ritual",
        accentToken: "bg-blue-500",
        sourceMeetingId: "product-roadmap-review",
    },
    {
        id: "product-top-v3-launch",
        circleId: "product",
        roleId: "product-circle",
        title: "Version 3 launch readiness",
        stage: "top",
        ownerId: "clara",
        subtitle: "Design and engineering alignment",
        accentToken: "bg-indigo-500",
        sourceMeetingId: "product-roadmap-review",
    },
    {
    ...
    {
        id: "growth-current-support-command",
        circleId: "growth",
        roleId: "customer-services",
        title: "Support command center",
        stage: "current",
        ownerId: "bob",
        subtitle: "SLA visibility and queue triage",
        accentToken: "bg-cyan-500",
        sourceMeetingId: "growth-retro",
    },
    {
        id: "growth-waiting-case-studies",
        circleId: "growth",
        roleId: "growth-role",
        title: "Customer case study pipeline",
        stage: "waiting",
        ownerId: "sarah",
        subtitle: "Waiting on customer approvals",
        accentToken: "bg-sky-500",
        sourceMeetingId: "growth-retro",
    },
    {
        id: "growth-done-nps-baseline",
        circleId: "growth",
        roleId: "customer-services",
        title: "NPS baseline and escalation map",
        stage: "done",
        ownerId: "alice",
        subtitle: "Baseline captured",
        accentToken: "bg-cyan-500",
    },
];
...
const ACTIONS: ActionRecord[] = [
    {
        id: "action-product-research-recruiting",
        circleId: "product",
        roleId: "product-circle",
        title: "Recruit five design partners for usability sessions",
        assigneeId: "ava",
        dueDate: buildTimedWindow(14, 17, 0, 30).start,
        completed: false,
        createdAt: buildTimedWindow(-2, 10, 0, 15).start,
        sourceMeetingId: "product-roadmap-review",
    },
    {
        id: "action-release-rubric",
        circleId: "product",
        roleId: "product-circle",
        title: "Draft the release quality review rubric",
        assigneeId: "felix",
        dueDate: buildTimedWindow(9, 15, 0, 30).start,
        completed: false,
        createdAt: buildTimedWindow(-3, 14, 0, 15).start,
        sourceMeetingId: "product-roadmap-review",
    },
    {
    ...
    {
        id: "action-support-playbook",
        circleId: "growth",
        roleId: "customer-services",
        title: "Publish escalation playbook in the support command center",
        assigneeId: "bob",
        dueDate: buildTimedWindow(8, 13, 30, 30).start,
        completed: false,
        createdAt: buildTimedWindow(-2, 15, 15, 15).start,
        sourceMeetingId: "growth-retro",
    },
    {
