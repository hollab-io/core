...
export class GovernanceModule {
    ...
    /**
     * Execute a raw governance change through the deprecated shortcut path.
     * @deprecated Prefer createProposal + adoptProposal so the proposal record
     *             is indexable and the public surface can render it. Retained
     *             for back-compat with the legacy SeedDemoOrgs / propose-
     *             tension flows. See MeetingFactory.sol executeGovernance
     *             deprecation notes.
     */
    async execute(
        meetingFactoryAddress: `0x${string}`,
