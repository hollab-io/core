export const HolGovernorAbi = [
    {
        ...
        inputs: [
            ...
            { name: "_timelock", type: "address", internalType: "contract TimelockController" },
            { name: "_votingDelay", type: "uint48", internalType: "uint48" },
            { name: "_votingPeriod", type: "uint32", internalType: "uint32" },
            { name: "_proposalThreshold", type: "uint256", internalType: "uint256" },
            { name: "_quorumNumerator", type: "uint256", internalType: "uint256" },
        ],
    ...
    },
    {
        ...
        inputs: [{ name: "newProposalThreshold", type: "uint256", internalType: "uint256" }],
        outputs: [],
        stateMutability: "nonpayable",
    },
    {
        type: "function",
        name: "setVotingDelay",
        inputs: [{ name: "newVotingDelay", type: "uint48", internalType: "uint48" }],
        outputs: [],
        stateMutability: "nonpayable",
    },
    {
        ...
        inputs: [{ name: "newVotingPeriod", type: "uint32", internalType: "uint32" }],
        outputs: [],
        stateMutability: "nonpayable",
    },
    {
    ...
    },
    {
        ...
        inputs: [{ name: "newQuorumNumerator", type: "uint256", internalType: "uint256" }],
        outputs: [],
        stateMutability: "nonpayable",
    },
    {
        ...
        name: "updateTimelock",
        inputs: [
            { name: "newTimelock", type: "address", internalType: "contract TimelockController" },
        ],
        outputs: [],
        stateMutability: "nonpayable",
    },
    ...
    { type: "event", name: "EIP712DomainChanged", inputs: [], anonymous: false },
    {
        ...
        inputs: [{ name: "proposalId", type: "uint256", indexed: false, internalType: "uint256" }],
        anonymous: false,
    },
    {
        type: "event",
    ...
    },
    {
        ...
        inputs: [
            { name: "proposalId", type: "uint256", indexed: false, internalType: "uint256" },
            { name: "etaSeconds", type: "uint256", indexed: false, internalType: "uint256" },
        ],
        anonymous: false,
    },
    {
    ...
    },
    {
        ...
        name: "TimelockChange",
        inputs: [
            { name: "oldTimelock", type: "address", indexed: false, internalType: "address" },
            { name: "newTimelock", type: "address", indexed: false, internalType: "address" },
        ],
        anonymous: false,
    },
    {
    ...
    },
    {
        ...
        name: "VotingDelaySet",
        inputs: [
            { name: "oldVotingDelay", type: "uint256", indexed: false, internalType: "uint256" },
            { name: "newVotingDelay", type: "uint256", indexed: false, internalType: "uint256" },
        ],
        anonymous: false,
    },
    {
        ...
        inputs: [
            { name: "oldVotingPeriod", type: "uint256", indexed: false, internalType: "uint256" },
            { name: "newVotingPeriod", type: "uint256", indexed: false, internalType: "uint256" },
        ],
        anonymous: false,
    },
    ...
    { type: "error", name: "GovernorInvalidVoteType", inputs: [] },
    {
        ...
        inputs: [{ name: "votingPeriod", type: "uint256", internalType: "uint256" }],
    },
    {
        type: "error",
    ...
    },
    {
        ...
        inputs: [
            { name: "proposalId", type: "uint256", internalType: "uint256" },
            { name: "current", type: "uint8", internalType: "enum IGovernor.ProposalState" },
