export const OrganizationFactoryAbi = [
    {
        type: "constructor",
        inputs: [
            { name: "_roleRegistryImpl", type: "address", internalType: "address" },
            { name: "_circleRegistryImpl", type: "address", internalType: "address" },
            { name: "_governanceProcessImpl", type: "address", internalType: "address" },
            { name: "_govFactory", type: "address", internalType: "address" },
            { name: "_ensRegistrar", type: "address", internalType: "address" },
        ],
    ...
    },
    {
        ...
        name: "ENS_REGISTRAR",
        inputs: [],
        outputs: [{ name: "", type: "address", internalType: "contract IENSSubdomainRegistrar" }],
    ...
    },
    {
        ...
        name: "GOV_FACTORY",
        inputs: [],
        outputs: [{ name: "", type: "address", internalType: "contract HolGovernorFactory" }],
        stateMutability: "view",
    },
    {
        type: "function",
    ...
    },
    {
        ...
        inputs: [
            { name: "_subname", type: "string", internalType: "string" },
        ...
        outputs: [{ name: "_orgId", type: "uint256", internalType: "uint256" }],
        stateMutability: "nonpayable",
    },
    {
        type: "function",
        ...
        outputs: [
            {
                ...
                components: [
                    ...
                    { name: "anchorCircleId", type: "uint256", internalType: "uint256" },
    ...
    },
    {
        ...
        inputs: [{ name: "_subname", type: "string", internalType: "string" }],
        outputs: [
            {
                name: "_org",
                type: "tuple",
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: "_subname", type: "string", indexed: false, internalType: "string" },
