export const CircleTreasuryAbi = [
    {
        ...
        inputs: [
            ...
            { name: "_minDelay", type: "uint256", internalType: "uint256" },
        ],
    ...
    },
    {
        ...
        name: "TIMELOCK",
        inputs: [],
        outputs: [{ name: "", type: "address", internalType: "contract TimelockController" }],
        stateMutability: "view",
    },
    {
        type: "function",
    ...
    { type: "error", name: "CircleTreasury_ETHTransferFailed", inputs: [] },
    { type: "error", name: "CircleTreasury_NotCircleLead", inputs: [] },
    { type: "error", name: "CircleTreasury_NotFacilitator", inputs: [] },
    {
        type: "error",
