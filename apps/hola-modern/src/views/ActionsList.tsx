    ...
    const visibleActions = snapshot.actions
        ...
        .filter((action) => {
            if (activeFilter === "mine")
                return (
                    snapshot.actions.find((a) => a.id === action.id)?.assigneeId ===
    ...
    return (
        <div className="flex h-full flex-col gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
                ...
                {/* Stats */}
                <span
                    className="rounded-full border border-blue-200/70 dark:border-blue-500/20
                ...
                <span
                    className="rounded-full border border-emerald-200/70 dark:border-emerald-500/20
            ...
            {/* List */}
            <div
                className="custom-scrollbar flex-1 overflow-auto rounded-2xl
                            ...
                            <div className="flex flex-shrink-0 items-center gap-3">
                                ...
                                {action.user ? (
                                    ...
                                    <button
                                        ...
                                        onClick={() => showToast("Owner assignment coming soon")}
                                ...
                                <button
                                    ...
                                    onClick={() => showToast("Action options coming soon")}
